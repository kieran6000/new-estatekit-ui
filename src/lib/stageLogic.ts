import { DEAD_STAGES, PARKED_STAGES, type LeadRow, type OutcomeStep, type Stage, type StageChangeExtra } from "../types";
 ...
 * Lead) have a fully-determined SOP patch and apply immediately. */
